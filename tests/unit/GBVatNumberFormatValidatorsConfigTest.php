...
namespace rocketfellows\GBVatNumberFormatValidatorsConfig\tests\unit;
...
use rocketfellows\GBVatNumberFormatValidatorsConfig\GBVatNumberFormatValidatorsConfig;

class GBVatNumberFormatValidatorsConfigTest extends TestCase
{
    private const TESTING_CONFIG_CLASS = GBVatNumberFormatValidatorsConfig::class;
    private const EXPECTED_CONFIG_DEFAULT_VALIDATOR_CLASS = GBVatFormatValidator::class;
    ...
    {
        $this->assertEquals(ISO3166::GB(), $config->getCountry());
    }
